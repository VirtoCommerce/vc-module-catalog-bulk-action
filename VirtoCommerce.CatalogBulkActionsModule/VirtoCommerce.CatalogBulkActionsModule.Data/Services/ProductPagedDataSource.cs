namespace VirtoCommerce.CatalogBulkActionsModule.Data.Services
{
    ...
    public class ProductPagedDataSource : PagedDataSource
    {
        ...
        protected virtual SearchResult SearchProductsInCategories(string[] categoryIds, int skip, int take)
        {
